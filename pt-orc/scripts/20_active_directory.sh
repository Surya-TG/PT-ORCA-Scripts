...
# MRK:20_NAV_TOC — Section index | nav,toc,index | L5-32
# - MRK:20_T01 — T01 DC DISCOVERY & PORT MAP | t01,dc,discovery,port,map | L33-33
# - MRK:20_T02 — T02 LDAP ENUMERATION (NULL + AUTH) | t02,ldap,enumeration,null,auth | L34-34
# - MRK:20_T03 — T03 NETBIOS / RPC ENUMERATION | t03,netbios,rpc,enumeration | L35-35
# - MRK:20_T04 — T04 SMB NULL SESSION & SHARE ENUM | t04,smb,null,session,share | L36-36
# - MRK:20_T05 — T05 KERBEROASTING (GetUserSPNs) | t05,kerberoasting,getuserspns | L37-37
# - MRK:20_T06 — T06 AS-REP ROASTING | t06,rep,roasting | L38-38
# - MRK:20_T07 — T07 PASSWORD POLICY ENUMERATION | t07,password,policy,enumeration | L39-39
# - MRK:20_T08 — T08 PRIVILEGED GROUP ENUMERATION | t08,privileged,group,enumeration | L40-40
# - MRK:20_T09 — T09 LLMNR / NBT-NS POISONING DETECTION | t09,llmnr,nbt,ns,poisoning | L41-41
# - MRK:20_T10 — T10 ADCS TEMPLATE ENUMERATION (ESC1-ESC8) | t10,adcs,template,enumeration,esc1 | L42-42
# - MRK:20_T11 — T11 BLOODHOUND COLLECTION | t11,bloodhound,collection | L43-43
# - MRK:20_T12 — T12 GPO ENUMERATION | t12,gpo,enumeration | L44-44
# - MRK:20_T13 — T13 ACL / ADMINSD HOLDER REVIEW | t13,acl,adminsd,holder,review | L45-45
# - MRK:20_T14 — T14 DELEGATION ENUMERATION | t14,delegation,enumeration | L46-46
# - MRK:20_T15 — T15 DOMAIN TRUST MAPPING | t15,domain,trust,mapping | L47-47
# - MRK:20_T16 — T16 PASSWORD SPRAYING (DEEP ONLY) | t16,password,spraying,deep | L48-48
# - MRK:20_T17 — T17 DCSYNC RIGHTS CHECK | t17,dcsync,rights,check | L49-49
# - MRK:20_T18 — T18 KERBEROS TICKET / HASH ATTACK SURFACE | t18,kerberos,ticket,hash,attack | L50-1477
# - MRK:20_T19 — T19 SHADOW CREDENTIALS (msDS-KeyCredentialLink) | t19,shadow,credentials,pkinit,keycredential | LXXXX-XXXX
# - MRK:20_T20 — T20 RESOURCE-BASED CONSTRAINED DELEGATION (RBCD) | t20,rbcd,delegation,s4u | LXXXX-XXXX
# - MRK:20_T21 — T21 ADCS ESC9–ESC13 | t21,adcs,esc9,esc10,esc11,esc13,certipy | LXXXX-XXXX
# - MRK:20_T22 — T22 SCCM/MECM ATTACK SURFACE | t22,sccm,mecm,pxe,naa,configmgr | LXXXX-XXXX
...
# - MRK:20_T01 — T01 DC DISCOVERY & PORT MAP
...
# - MRK:20_T02 — T02 LDAP ENUMERATION (NULL + AUTH)
test_T02_ldap_enum() {
    local dc="${AD_DC_IP}"
...
# - MRK:20_T03 — T03 NETBIOS / RPC ENUMERATION
...
# - MRK:20_T04 — T04 SMB NULL SESSION & SHARE ENUMERATION
test_T04_smb_shares() {
    local dc="${AD_DC_IP}"
...
# - MRK:20_T05 — T05 KERBEROASTING (GetUserSPNs)
...
# - MRK:20_T06 — T06 AS-REP ROASTING
...
# - MRK:20_T07 — T07 PASSWORD POLICY ENUMERATION
...
# - MRK:20_T08 — T08 PRIVILEGED GROUP ENUMERATION
...
# - MRK:20_T09 — T09 LLMNR / NBT-NS POISONING DETECTION
...
# - MRK:20_T10 — T10 ADCS TEMPLATE ENUMERATION (ESC1-ESC8)
test_T10_adcs_enum() {
    local dc="${AD_DC_IP}"
...
# - MRK:20_T11 — T11 BLOODHOUND COLLECTION
test_T11_bloodhound() {
    local dc="${AD_DC_IP}"
...
# - MRK:20_T13 — T13 ACL / ADMINSD HOLDER REVIEW
test_T13_acl_review() {
    local dc="${AD_DC_IP}"
...
# - MRK:20_T14 — T14 DELEGATION ENUMERATION
test_T14_delegation() {
    local dc="${AD_DC_IP}"
...
# - MRK:20_T15 — T15 DOMAIN TRUST MAPPING
...
# - MRK:20_T16 — T16 PASSWORD SPRAYING (DEEP ONLY)
...
# - MRK:20_T17 — T17 DCSYNC RIGHTS CHECK
...
# - MRK:20_T18 — T18 KERBEROS TICKET / HASH ATTACK SURFACE
...
# =============================================================================
# - MRK:20_T19 — T19 SHADOW CREDENTIALS (msDS-KeyCredentialLink)
# =============================================================================
...
# =============================================================================
# - MRK:20_T20 — T20 RESOURCE-BASED CONSTRAINED DELEGATION (RBCD)
# =============================================================================
test_T20_rbcd_enum() {
    local dc="${AD_DC_IP}"
...
# =============================================================================
# - MRK:20_T21 — T21 ADCS ESC9–ESC13
# =============================================================================
...
# =============================================================================
# - MRK:20_T22 — T22 SCCM/MECM ATTACK SURFACE
# =============================================================================
test_T22_sccm_mecm() {
    local dc="${AD_DC_IP}"
