...
# MRK:13_NAV_TOC — Section index | nav,toc,index | L5-99
# - MRK:13_ROOT — ROOT CHECK | root,check | L100-109 | ⚠ no-insert-before
# - MRK:13_CONF — ENGAGEMENT CONFIGURATION | conf,engagement,configuration,edit,pt | L110-156 | ⚠ no-insert-before; propose-before-edit; read-toc-first
# - MRK:13_LOG — COLOURS AND LOGGING | log,colours,logging | L157-178 | ⚠ no-insert-before
# - MRK:13_ARGS — ARGUMENT PARSING | args,argument,parsing | L179-206 | ⚠ no-insert-before
# - MRK:13_DB — MSF DB + MODULE RUNNER | db,msf,module,runner,tcp | L207-271 | ⚠ no-insert-before; propose-before-edit; read-toc-first
# - MRK:13_RESULTS — RESULT TRACKING + FINDING WRITER | results,result,tracking,finding,writer | L272-281 | ⚠ no-insert-before
# - MRK:13_FIND — FINDING WRITER | find,finding,writer,jsonl,emit | L282-400 | ⚠ no-insert-before
# - MRK:13_PARSE — INPUT PARSING | parse,input,parsing,manual,followup | L401-722 | ⚠ no-insert-before; read-toc-first
# - MRK:13_TOOLS — TOOL AVAILABILITY | tools,tool,availability,check,startup | L723-747 | ⚠ no-insert-before
# - MRK:13_DIR — EVIDENCE DIR HELPER | dir,evidence,helper | L748-759 | ⚠ no-insert-before
# - MRK:13_P_REDIS — PROBE: REDIS NOAUTH | redis,probe,noauth,cli,ping | L760-830 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_MYSQL — PROBE: MYSQL NOAUTH / ANONYMOUS LOGIN | mysql,probe,noauth,anonymous,login | L831-891 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_PG — PROBE: POSTGRESQL NOAUTH | pg,probe,postgresql,noauth,postgres | L892-956 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_MONGO — PROBE: MONGODB NOAUTH | mongo,probe,mongodb,noauth,listdatabases | L957-1022 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_SSH — PROBE: SSH VERSION | ssh,probe,version,cve,regresshion | L1023-1199 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_FTP — PROBE: FTP ANONYMOUS LOGIN | ftp,probe,anonymous,login | L1200-1271 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_SMB — PROBE: SMB NULL SESSION (PTI) | smb,probe,null,session,pti | L1272-1343 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_SNMP — PROBE: SNMP DEFAULT COMMUNITY | snmp,probe,default,community,v1 | L1344-1405 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_SMTP — PROBE: SMTP OPEN RELAY | smtp,probe,open,relay,swaks | L1406-1472 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_SSRF — PROBE: SSRF → IMDS (PTE) | ssrf,probe,imds,pte,aws | L1473-1547 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_TLS — PROBE: TLS CERT VALIDITY | tls,probe,cert,validity,expiry | L1548-1613 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_WEBH — PROBE: HTTP SECURITY HEADERS | webh,probe,http,security,headers | L1614-1661 | ⚠ no-insert-before; read-toc-first
# - MRK:13_ENUM — POST-VULN ENUMERATION | enum,post,vuln,enumeration,redis | L1662-1833 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_MSSQL — PROBE: MSSQL | mssql,probe,unauthenticated,sa,empty | L1834-1880 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_NFS — PROBE: NFS | nfs,probe,showmount,world,accessible | L1881-1919 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_TELNET — PROBE: Telnet | telnet,probe,banner,grab,cleartext | L1920-1956 | ⚠ no-insert-before
# - MRK:13_P_IPMI — PROBE: IPMI | ipmi,probe,version,cipher,zero | L1957-2011 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_RDP — PROBE: RDP | rdp,probe,nla,check,encryption | L2012-2055 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_WINRM — PROBE: WinRM | winrm,probe,auth,exposure,check | L2056-2107 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_MEMCACHED — PROBE: Memcached NOAUTH | memcached,probe,noauth | L2108-2147 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_DOCKER — PROBE: Docker Remote API | docker,probe,remote,api,unauth | L2148-2194 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_K8S — PROBE: Kubernetes API RBAC | k8s,probe,kubernetes,api,rbac | L2195-2264 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_CONSUL — PROBE: Consul ACL Bypass | consul,probe,acl,bypass | L2265-2317 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_VAULT — PROBE: Vault Dev/Root Token | vault,probe,dev,root,token | L2318-2381 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_KAFKA — PROBE: Kafka NOAUTH | kafka,probe,noauth,sasl | L2382-2432 | ⚠ no-insert-before; read-toc-first
# - MRK:13_P_WEBGEN — PROBE: Web generic + 2025 CVEs | webgen,probe,web,generic,cves | L2433-3027 | ⚠ no-insert-before; read-toc-first
# - MRK:13_INGEST — PHASE 0 INGEST | ingest,phase,parse,prior,tls | L3028-3332 | ⚠ insert-here
# - MRK:13_DISPATCH — PROBE DISPATCHER | dispatch,probe,dispatcher,svc,function | L3333-3482 | ⚠ no-insert-before; read-toc-first
# - MRK:13_REPORT — REPORT WRITER | report,writer,working,verify,summary | L3483-3590 | ⚠ no-insert-before; read-toc-first
# - MRK:13_CONFIRM — SCOPE CONFIRMATION | confirm,scope,confirmation | L3591-3618 | ⚠ no-insert-before; propose-before-edit
# - MRK:13_MAIN — MAIN entry point | main,entry,point | L3619-3681 | ⚠ no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_ROOT — ROOT CHECK | root,check | L100-109
...
# =============================================================================
# MRK:13_CONF — ENGAGEMENT CONFIGURATION | conf,engagement,configuration,edit,pt | L110-156
...
# =============================================================================
# MRK:13_LOG — COLOURS AND LOGGING | log,colours,logging | L157-178
# NAV-RULE: no-insert-before
# =============================================================================
...
# =============================================================================
# MRK:13_ARGS — ARGUMENT PARSING | args,argument,parsing | L179-206
# NAV-RULE: no-insert-before
# =============================================================================
...
# =============================================================================
# MRK:13_DB — MSF DB + MODULE RUNNER | db,msf,module,runner,tcp | L207-271
# NAV-RULE: no-insert-before; propose-before-edit; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_RESULTS — RESULT TRACKING + FINDING WRITER | results,result,tracking,finding,writer | L272-281
# NAV-RULE: no-insert-before
# =============================================================================
...
# =============================================================================
# MRK:13_FIND — FINDING WRITER | find,finding,writer,jsonl,emit | L282-400
# NAV-RULE: no-insert-before
# =============================================================================
...
_CURRENT_IP=""
_SKIP_AUTO_EMIT=0
FINDINGS_FILE="${SCRIPT_DIR}/working/$(ev_fname "13-svcverify-findings" "jsonl")"
...
# =============================================================================
# MRK:13_PARSE — INPUT PARSING | parse,input,parsing,manual,followup | L401-722
...
# =============================================================================
# MRK:13_TOOLS — TOOL AVAILABILITY | tools,tool,availability,check,startup | L723-747
# NAV-RULE: no-insert-before
# =============================================================================
...
# =============================================================================
# MRK:13_DIR — EVIDENCE DIR HELPER | dir,evidence,helper | L748-759
# NAV-RULE: no-insert-before
# =============================================================================
...
# =============================================================================
# MRK:13_P_REDIS — PROBE: REDIS NOAUTH | redis,probe,noauth,cli,ping | L760-830
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_P_MYSQL — PROBE: MYSQL NOAUTH / ANONYMOUS LOGIN | mysql,probe,noauth,anonymous,login | L831-891
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_P_PG — PROBE: POSTGRESQL NOAUTH | pg,probe,postgresql,noauth,postgres | L892-956
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_MONGO — PROBE: MONGODB NOAUTH | mongo,probe,mongodb,noauth,listdatabases | L957-1022
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_P_SSH — PROBE: SSH VERSION | ssh,probe,version,cve,regresshion | L1023-1199
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_FTP — PROBE: FTP ANONYMOUS LOGIN | ftp,probe,anonymous,login | L1200-1271
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_P_SMB — PROBE: SMB NULL SESSION (PTI) | smb,probe,null,session,pti | L1272-1343
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_P_SNMP — PROBE: SNMP DEFAULT COMMUNITY | snmp,probe,default,community,v1 | L1344-1405
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_P_SMTP — PROBE: SMTP OPEN RELAY | smtp,probe,open,relay,swaks | L1406-1472
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_P_SSRF — PROBE: SSRF → IMDS (PTE) | ssrf,probe,imds,pte,aws | L1473-1547
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_TLS — PROBE: TLS CERT VALIDITY | tls,probe,cert,validity,expiry | L1548-1613
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_P_WEBH — PROBE: HTTP SECURITY HEADERS | webh,probe,http,security,headers | L1614-1661
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_ENUM — POST-VULN ENUMERATION | enum,post,vuln,enumeration,redis | L1662-1833
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_MSSQL — PROBE: MSSQL | mssql,probe,unauthenticated,sa,empty | L1834-1880
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_NFS — PROBE: NFS | nfs,probe,showmount,world,accessible | L1881-1919
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
probe_nfs() {
...
# =============================================================================
# MRK:13_P_TELNET — PROBE: Telnet | telnet,probe,banner,grab,cleartext | L1920-1956
# NAV-RULE: no-insert-before
# =============================================================================
probe_telnet() {
...
# =============================================================================
# MRK:13_P_IPMI — PROBE: IPMI | ipmi,probe,version,cipher,zero | L1957-2011
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_RDP — PROBE: RDP | rdp,probe,nla,check,encryption | L2012-2055
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
probe_rdp() {
...
# =============================================================================
# MRK:13_P_WINRM — PROBE: WinRM | winrm,probe,auth,exposure,check | L2056-2107
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
probe_winrm() {
...
# =============================================================================
# =============================================================================
# MRK:13_P_MEMCACHED — PROBE: Memcached NOAUTH | memcached,probe,noauth | L2108-2147
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_DOCKER — PROBE: Docker Remote API | docker,probe,remote,api,unauth | L2148-2194
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_K8S — PROBE: Kubernetes API RBAC | k8s,probe,kubernetes,api,rbac | L2195-2264
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_CONSUL — PROBE: Consul ACL Bypass | consul,probe,acl,bypass | L2265-2317
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_VAULT — PROBE: Vault Dev/Root Token | vault,probe,dev,root,token | L2318-2381
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_KAFKA — PROBE: Kafka NOAUTH | kafka,probe,noauth,sasl | L2382-2432
# NAV-RULE: no-insert-before; read-toc-first
...
# =============================================================================
# MRK:13_P_WEBGEN — PROBE: Web generic + 2025 CVEs | webgen,probe,web,generic,cves | L2433-3027
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
probe_web_generic() {
    local ip="$1" port="${2:-80}"
...
# =============================================================================
# MRK:13_INGEST — PHASE 0 INGEST | ingest,phase,parse,prior,tls | L3028-3332
...
# =============================================================================
# MRK:13_DISPATCH — PROBE DISPATCHER | dispatch,probe,dispatcher,svc,function | L3333-3482
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
...
# =============================================================================
# MRK:13_REPORT — REPORT WRITER | report,writer,working,verify,summary | L3483-3590
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================

write_verify_summary() {
    local report_file="working/$(ev_fname "13-svcverify-summary" "md")"
...
# =============================================================================
# MRK:13_CONFIRM — SCOPE CONFIRMATION | confirm,scope,confirmation | L3591-3618
...
# =============================================================================
# MRK:13_MAIN — MAIN entry point | main,entry,point | L3619-3681
# NAV-RULE: no-insert-before; read-toc-first
# =============================================================================
